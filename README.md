...
A: 1. Find all instances of naked twins. Search for a duplicated two-digit items in every unit.
...
A: We are using same solution like for the regular sudoku, with additional two units for diagonals.
